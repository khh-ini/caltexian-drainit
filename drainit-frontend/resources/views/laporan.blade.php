                                ...
                                <th scope="col" class="sort" data-sort="budget">Jumlah Vote
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item" href="{{ url('laporan/sortedup') }}">sort up vote <i class="fa fa-thumbs-up"></i></a>
                                            <a class="dropdown-item" href="{{ url('laporan/sorteddown') }}">sort down vote <i class="fa fa-thumbs-down"></i></a>
                                        </div>
                                    </div>
                                </th>
